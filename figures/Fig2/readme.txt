...
2. Normal-4e-10-4e-7-151points.txt
...
3. AMPAR-Ca-Scan.pdf,Key-Species-Scan.pdf,CaMKII-P-Scan.pdf
...
5.7.14E-9-800S-0.0001s.txtcompress.txt, 7.47E-9-800S-0.0001s.txtcompress.txt
Compressed raw data. The point from the old raw data was pick to reduce the size of file. (Now 0.1 s resolution). The shape of the curve was not changed. 
