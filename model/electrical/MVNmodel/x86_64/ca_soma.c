...
#define nrn_init _nrn_init__ca_soma
#define _nrn_initial _nrn_initial__ca_soma
#define nrn_cur _nrn_cur__ca_soma
#define _nrn_current _nrn_current__ca_soma
#define nrn_jacob _nrn_jacob__ca_soma
#define nrn_state _nrn_state__ca_soma
#define _net_receive _net_receive__ca_soma 
#define factors factors__ca_soma 
#define state state__ca_soma 
#define states states__ca_soma 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 163, 4);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "diam");
 	...
 	ivoc_help("help ?1 ca_soma /Users/xiey/Dropbox/GitHub/multiscale-synaptic-model/model/electrical/MVNmodel/x86_64/ca_soma.mod\n");
