...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 0, "cvodeieq");
 	...
 	ivoc_help("help ?1 nap /Users/xiey/Dropbox/GitHub/multiscale-synaptic-model/model/electrical/MVNmodel/x86_64/nap.mod\n");
...
double alpham ( _threadargsprotocomma_ double _lVm ) {
   double _lalpham;
  _lalpham = 0.12 * exp ( 0.12 * ( _lVm + 56.0 ) ) ;
...
double betam ( _threadargsprotocomma_ double _lVm ) {
   double _lbetam;
  _lbetam = 0.12 * exp ( - 0.03 * ( _lVm + 56.0 ) ) ;
