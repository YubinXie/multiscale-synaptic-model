...
extern Memb_func* memb_func;
 ...
 "g_kleak", "siemens/cm2",
 "Erev_kleak", "millivolt",
 "i_kleak", "milliamp/cm2",
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 5, 0);
 	...
 	ivoc_help("help ?1 kleak /Users/xiey/Dropbox/GitHub/multiscale-synaptic-model/model/electrical/MVNmodel/x86_64/kleak.mod\n");
